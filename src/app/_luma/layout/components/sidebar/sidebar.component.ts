...
export class SidebarComponent implements OnInit {
  ...
  questions: ReadonlyArray<string> = [
    ...
    "When to expect new version of Luma Laravel ?",
    "Could not get Luma Demo 7 working",
  ...
  tutorials: ReadonlyArray<string> = [
    ...
    "Luma file structure and build tools",
    "Luma integration with Blazor server side",
  ];
