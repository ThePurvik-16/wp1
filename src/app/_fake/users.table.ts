  ...
  public static users: any = [
    {
      ...
      emailSettings: {
        ...
        updatesFromLuma: {
          newsAboutLumaProductsAndFeatureUpdates: false,
          tipsOnGettingMoreOutOfKeen: false,
          thingsYouMissedSindeYouLastLoggedIntoKeen: true,
          newsAboutLumaOnPartnerProductsAndOtherServices: true,
          tipsOnLumaBusinessProducts: true,
        },
      },
      communication: {
        email: true,
    ...
    },
    {
      ...
      firstname: 'Megan',
      lastname: 'Fox',
      occupation: 'Deputy Head of Luma in New York office',
      companyName: 'Luma',
      phone: '456669067891',
      language: 'en',
      timeZone: 'International Date Line West',
